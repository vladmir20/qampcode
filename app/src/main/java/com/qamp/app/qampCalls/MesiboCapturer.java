...
public class MesiboCapturer implements CameraSwitchHandler {
    ...
    private int mHeight;
    private int mFps;
    private VideoSink mRenderer = null;
    private MesiboCapturerListener mListner;
    private boolean mFrontCamera = true;

    public MesiboCapturer(MesiboCapturerListener var1, PeerConnectionClient var2, VideoCapturer var3, VideoSink var4, int var5, int var6, int var7) {
        this.mListner = var1;
        this.m_pcc = var2;
        this.mCapturer = var3;
        this.mRenderer = var4;
        ...
        this.mHeight = var6;
        this.mFps = var7;
        SurfaceTextureHelper var8 = this.m_pcc.getSurfaceTextureHelper();
        PeerConnectionFactory var9 = this.m_pcc.getFactory();
        this.mVideosource = var9.createVideoSource(var3.isScreencast());
        this.mCapturer.initialize(var8, this.m_pcc.getAppContext(), this.mVideosource.getCapturerObserver());
        this.mVideoTrack = var9.createVideoTrack(this.m_pcc.getVideoTrackId(), this.mVideosource);
