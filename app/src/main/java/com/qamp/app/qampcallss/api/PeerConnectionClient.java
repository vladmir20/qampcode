...
public class PeerConnectionClient {
    ...
    private void initStunServers() {
        PeerConnection.IceServer var1 = PeerConnection.IceServer.builder("stun:stun.l.google.com:19302").setUsername("").setPassword("").createIceServer();
        this.mIceServers.add(var1);
        var1 = PeerConnection.IceServer.builder("stun:stun1.l.google.com:19302").setUsername("").setPassword("").createIceServer();
        this.mIceServers.add(var1);
        var1 = PeerConnection.IceServer.builder("stun:stun2.l.google.com:19302").setUsername("").setPassword("").createIceServer();
        this.mIceServers.add(var1);
    }
    ...
    public PeerConnectionClient(Context var1, EglBase var2, PeerConnectionParameters var3, PeerConnectionEvents var4) {
        ...
        PeerConnectionFactory.initialize(PeerConnectionFactory.InitializationOptions.builder(var1).setFieldTrials(var5).setEnableInternalTracer(true).createInitializationOptions());
    }

    public void createPeerConnectionFactory(PeerConnectionFactory.Options var1) {
    ...
    public void addIceServers(PeerConnection.IceServer var1) {
        this.mIceServers.add(var1);
    }
    ...
    private void createPeerConnectionFactoryInternal(PeerConnectionFactory.Options var1) {
        this.isError = false;
    ...
    AudioDeviceModule createJavaAudioDevice() {
        JavaAudioDeviceModule.AudioRecordErrorCallback var1 = new JavaAudioDeviceModule.AudioRecordErrorCallback() {
            public void onWebRtcAudioRecordInitError(String var1) {
                PeerConnectionClient.this.reportError(var1);
            }

            public void onWebRtcAudioRecordStartError(JavaAudioDeviceModule.AudioRecordStartErrorCode var1, String var2) {
        ...
        JavaAudioDeviceModule.AudioTrackErrorCallback var2 = new JavaAudioDeviceModule.AudioTrackErrorCallback() {
            public void onWebRtcAudioTrackInitError(String var1) {
                PeerConnectionClient.this.reportError(var1);
            }

            public void onWebRtcAudioTrackStartError(JavaAudioDeviceModule.AudioTrackStartErrorCode var1, String var2) {
    ...
    private void checkTransceiver() {
        ...
        while(var1.hasNext()) {
            ...
            var2.getMid();
            var2.getMediaType();
            MediaStreamTrack.MediaType var10000 = MediaStreamTrack.MediaType.MEDIA_TYPE_AUDIO;
            RtpSender var3;
    ...
    private PeerConnection.RTCConfiguration initRtcConfig(List<PeerConnection.IceServer> var1) {
        PeerConnection.RTCConfiguration var2;
        (var2 = new PeerConnection.RTCConfiguration(var1)).tcpCandidatePolicy = this.peerConnectionParameters.tcpCandidates ? PeerConnection.TcpCandidatePolicy.ENABLED : PeerConnection.TcpCandidatePolicy.DISABLED;
        var2.bundlePolicy = PeerConnection.BundlePolicy.MAXBUNDLE;
        var2.rtcpMuxPolicy = PeerConnection.RtcpMuxPolicy.REQUIRE;
        var2.continualGatheringPolicy = PeerConnection.ContinualGatheringPolicy.GATHER_CONTINUALLY;
        var2.keyType = PeerConnection.KeyType.ECDSA;
        var2.enableDtlsSrtp = !this.peerConnectionParameters.loopback;
        var2.sdpSemantics = this.peerConnectionParameters.unifiedPlan ? PeerConnection.SdpSemantics.UNIFIED_PLAN : PeerConnection.SdpSemantics.PLAN_B;
        return var2;
    }
    ...
    private void createPeerConnectionInternal(boolean var1) {
        if (this.factory != null && !this.isError) {
            ...
            this.sdpMediaConstraints.mandatory.add(new MediaConstraints.KeyValuePair("OfferToReceiveAudio", Boolean.toString(this.isAudioCallEnabled() && var1)));
            this.sdpMediaConstraints.mandatory.add(new MediaConstraints.KeyValuePair("OfferToReceiveVideo", Boolean.toString(this.isVideoCallEnabled() && var1)));
            PeerConnection.RTCConfiguration var2 = this.initRtcConfig(this.mIceServers);
            this.peerConnection = this.factory.createPeerConnection(var2, this.pcObserver);
            if (this.dataChannelEnabled) {
                DataChannel.Init var3;
                (var3 = new DataChannel.Init()).ordered = this.peerConnectionParameters.dataChannelParameters.ordered;
    ...
    public void setRemoteDescription(SessionDescription var1) {
        ...
        executor.execute(() -> {
            if (this.peerConnection != null && !this.isError) {
                ...
                final SessionDescription tempVar2 = new SessionDescription(var1.type, var2);
                this.peerConnection.setRemoteDescription(this.sdpObserver, var1);
            }
        });
    }
            ...
            if (this.peerConnection != null && this.localVideoSender != null && !this.isError) {
                ...
                if (this.localVideoSender != null) {
                    ...
                    if ((var2 = this.localVideoSender.getParameters()).encodings.size() != 0) {
                        for(Iterator var3 = var2.encodings.iterator(); var3.hasNext(); ((RtpParameters.Encoding)var3.next()).maxBitrateBps = var1 == null ? null : var1 * 1000) {
                        }
    ...
    protected AudioTrack createAudioTrack() {
        ...
        if (this.peerConnectionParameters.noAudioProcessing) {
            var1.mandatory.add(new MediaConstraints.KeyValuePair("googEchoCancellation", "false"));
            var1.mandatory.add(new MediaConstraints.KeyValuePair("googAutoGainControl", "false"));
            var1.mandatory.add(new MediaConstraints.KeyValuePair("googHighpassFilter", "false"));
            var1.mandatory.add(new MediaConstraints.KeyValuePair("googNoiseSuppression", "false"));
        }
        ...
        public void onCreateSuccess(SessionDescription var1) {
            ...
            PeerConnectionClient.executor.execute(() -> {
                if (PeerConnectionClient.this.peerConnection != null && !PeerConnectionClient.this.isError) {
                    ...
                    PeerConnectionClient.this.peerConnection.setLocalDescription(PeerConnectionClient.this.sdpObserver, var1);
                }
    ...
    private class PCObserver implements PeerConnection.Observer {
        ...
        public void onIceConnectionChange(PeerConnection.IceConnectionState var1) {
            PeerConnectionClient.executor.execute(() -> {
                ...
                if (var1 == PeerConnection.IceConnectionState.CONNECTED) {
                    PeerConnectionClient.this.events.onIceConnected();
                } else if (var1 == PeerConnection.IceConnectionState.DISCONNECTED) {
                    PeerConnectionClient.this.events.onIceDisconnected();
                } else {
                    if (var1 == PeerConnection.IceConnectionState.FAILED) {
        ...
        public void onDataChannel(final DataChannel var1) {
            ...
            if (PeerConnectionClient.this.dataChannelEnabled) {
                var1.registerObserver(new DataChannel.Observer() {
                    ...
                    public void onMessage(DataChannel.Buffer var1x) {
                        if (var1x.binary) {
