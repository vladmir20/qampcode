...
{
    public static List<WelcomeScreen> mScreens;
    ...
    public static OtpView.OtpViewConfig otpConfig;
    
    static {
        MesiboUiHelperConfig.mScreens = null;
        ...
        MesiboUiHelperConfig.otpConfig = new OtpView.OtpViewConfig();
    }
}
