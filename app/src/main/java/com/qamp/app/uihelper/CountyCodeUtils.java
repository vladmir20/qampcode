...
public class CountyCodeUtils
{
    ...
    public static class CountryInfo
    {
        ...
        public CountryInfo(final String cn, final int cc) {
            this.countryName = "";
            this.shortName = "";
            this.countryCode = 0;
            this.countryName = cn;
        ...
        public CountryInfo(final String cn, final String sn, final int cc) {
            this.countryName = "";
            this.shortName = "";
            this.countryCode = 0;
            this.countryName = cn;
