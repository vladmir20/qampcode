...
public class EditProfileFragment extends Fragment implements MediaPicker.ImageEditorListener, MesiboProfile.Listener {
    ...
    void setUserPicture() {
        ...
        if (null != image) {
            ...
            mProfileImage.setImageDrawable(new RoundImageDrawable(BitmapFactory.decodeResource(MainApplication.getAppContext().getResources(), R.drawable.default_user_image)));
        }
