...
import com.qamp.app.messaging.MesiboMessagingActivity;
import com.qamp.app.messaging.MesiboUserListActivityNew;
import com.qamp.app.uihelper.LoginActivity;
...
//        context.startActivity(intent);
    ...
    public static void launchMesibo(Context context, int flag, boolean startInBackground, boolean keepRunningOnBackPressed) {
        ...
        com.qamp.app.messaging.MesiboUI.launch(context, flag, startInBackground, keepRunningOnBackPressed);
    }
